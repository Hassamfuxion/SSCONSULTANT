  ...
  <div className="row">
    <div className="col-lg-5">
      <div className="dexon-section-title white padding-lg">
        <h4>Services</h4>
        <h1>OUR PRODUCTS</h1>
        <h1 className="sections">We Provide</h1>
      </div>
    </div>
      ...
      <div className="row">
        ...
        <div className="col-lg-12">
          <div className="single-service-box2">
            ...
            <div className="service-content">
              <h2 className="service-title">Finance & Performance Management</h2>
              <p className="service-desc">
                Accounts Payable, Accounts Receivable, Fixed Assets, General Ledger, Time Billing
              </p>
        ...
        <div className="col-lg-12">
          <div className="single-service-box2">
            ...
            <div className="service-content">
              <h2 className="service-title">Human Resource & Security</h2>
              <p className="service-desc">
                HR, Payroll, Security, Sales Analysis
              </p>
              <div className="right-arrow">
                <a href="./service">
                  <i className="bi bi-arrow-right-short" />
        ...
        <div className="col-lg-12">
          <div className="single-service-box2">
            <div className="service-icon">
              <img src="assets/images/resource/icongif27.gif" alt="" />
            </div>
            <div className="service-content">
              <h2 className="service-title">Supply Chain & Manufacturing</h2>
              <p className="service-desc">
                Inventory, Purchasing, Shipping, Packing List, Merchandising
              </p>
              <div className="right-arrow">
                <a href="./service">
                  <i className="bi bi-arrow-right-short" />
        ...
        <div className="col-lg-12">
          <div className="single-service-box2">
            ...
            <div className="service-content">
              <h2 className="service-title">Logistics & Transport</h2>
              <p className="service-desc">
                EPC Management, Barcode Management, Vehicle Management
              </p>
              <div className="right-arrow">
                <a href="./service">
                  <i className="bi bi-arrow-right-short" />
